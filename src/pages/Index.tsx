...
const PRICES = [
  { service: "Ремонт ДВС", price: "от 10 000 ₽" },
  { service: "Ремонт КПП", price: "от 5 000 ₽" },
  { service: "Ремонт АКПП", price: "от 10 000 ₽" },
  { service: "Тормозная система", price: "от 2 000 ₽" },
  { service: "Ходовая часть", price: "от 1 500 ₽" },
  { service: "Замена агрегатов", price: "от 5 000 ₽" },
  { service: "Топливная система", price: "от 2 500 ₽" },
